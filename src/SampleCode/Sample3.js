...
const Sample3 = () => {
  return (
    <Container backgroundColor="#fffff" className="pt-16 pb-16">
      <Element is={Container} id="Sample3">
        <Element
          is={Container}
          id="Sample3-Item1"
        ...
        <Element
          ...
          id="Sample3-Item2"
          classes={[
            "grid gap-2 pt-8 md:mx-28 lg:mx-44 items-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3",
          ]}
        >
          <Element
            is={Container}
